...
public class IntersectionDetector2D {
    ...
    public static boolean pointOnLine(Vector2f point, Line2D line) {
        ...
        if (dx == 0f) {
            return CatMath.compare(point.x, line.getFrom().x);
        }
        float m = dy / dx;
    ...
    public static boolean pointInBox2D(Vector2f point, Box2D box) {
        ...
        CatMath.rotate(pointLocalBoxSpace, box.getRigidbody().getRotation(),
    ...
    public static boolean lineAndBox2D(Line2D line, Box2D box) {
        ...
        CatMath.rotate(localStart, theta, center);
        CatMath.rotate(localEnd, theta, center);
    ...
    public static boolean raycast(Box2D box, Ray2D ray, RaycastResult result) {
        ...
        CatMath.rotate(xAxis, -box.getRigidbody().getRotation(), new Vector2f(0, 0));
        CatMath.rotate(yAxis, -box.getRigidbody().getRotation(), new Vector2f(0, 0));
    ...
    public static boolean circleAndBox2D(Circle circle, Box2D box) {
        ...
        CatMath.rotate(r, -box.getRigidbody().getRotation(), new Vector2f());

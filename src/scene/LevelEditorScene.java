...
//        physics.addRigidbody(rb2);
		...
		sprites = AssetPool.getSpritesheet("res/textures/spritesheets/dungeon.png");
		if (levelLoaded) {
	...
	private void loadResources() {
		...
		AssetPool.addSpritesheet("res/textures/spritesheets/dungeon.png",
				new Spritesheet(AssetPool.getTexture("res/textures/spritesheets/dungeon.png"),
						16, 16, 255, 0));
		AssetPool.getTexture("res/textures/WTF.png");
